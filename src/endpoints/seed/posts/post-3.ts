...
export const post3: (args: PostArgs) => RequiredDataFromCollectionSlug<'posts'> = ({
  ...
  return {
    slug: 'impact-stories-transforming-lives-through-education',
    _status: 'published',
    authors: [author],
    content: {
      root: {
            ...
            children: [
              {
                ...
                mode: 'normal',
                style: '',
                text: 'Education is a powerful tool for transformation. It opens doors, creates opportunities, and empowers individuals to reach their full potential.',
                version: 1,
              },
            ],
            direction: 'ltr',
    ...
    meta: {
      description: `Explore inspiring stories of how education transforms lives. From empowering individuals to uplifting communities, discover the impact of learning.`,
      image: heroImage.id,
      title: 'Impact Stories: Transforming Lives Through Education',
    },
